VR(39) = 1
VR(65) = 550
VR(120) = VR(32) ' Store Y1 Enable
VR(121) = VR(31) ' Store Y2 Enable
...
IF (VR(120) = 1) THEN
    BASE(0,1)
ELSEIF (VR(121) = 1) OR(VR(34) = 1) THEN
    BASE(0,2)
ENDIF
       ...
       ELSEIF (VR( (VR(65)+(VR(66)*9)) ) = 0) THEN
           ...
           IF ((VR(80) = 1) AND (VR(66) = 0)) THEN
                ...
                IF (VR(34) = 1) THEN
                    ...
                    ENDIF
                    BASE(0,2,1) 'y axis's swaped for x2
                    MOVEABS(VR(71),VR(72),VR(72)+(VR(41)+VR(42)/10000))
                    WAIT IDLE
                    BASE(1)
                    CONNECT(1,2)
                    BASE(5,4) ' swaped for x2
                    SPEED = 90
                    ACCEL = 90
                    DECEL = 90
                    ...
                    MOVEABS(0,0)
                    WAIT IDLE
                    BASE(0,2) 'axis 2 changed for x2
...
'        BASE(0,1,2)
 ...
 '       WAIT IDLE
        ...
        BASE(0,2) ' axis 2 swapped for x2
    ELSE
