...
ELSE
   ...
   ' FS_LIMIT = 259
    ...
    OP(27,1)
    VR(92) = TIME
    WAIT UNTIL ((IN(27) = 1) OR ((TIME-VR(92)) > 60))
   ' OP(19,0)
    IF (IN(25) = 0) THEN
...
ELSE
    IF (IN(24) = 1) THEN
        ...
        WA(1000)
        SPEED = 40
        MOVE(23.5) 'move to offset for 0 position
        WAIT IDLE
        DEFPOS(0)
VR(105) = MPOS AXIS(5)
        VR(8) = 2
...
ELSE
    IF (IN(16) = 1) THEN
        ...
        WA(1000)
        SPEED = 40
        MOVE(11.70) 'move to offset for 0 position
        WAIT IDLE
        DEFPOS(0)
VR(106) = MPOS AXIS(4)
